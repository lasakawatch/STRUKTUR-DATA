...
// Fungsi untuk inisialisasi array HARI dan JAM, dan MATKUL_TERSEDIA
void inisialisasiWaktu() {
    ...
    MATKUL_TERSEDIA = {
        {"Struktur Data", HARI[0] + JAM[8] + 0, HARI[0] + JAM[9] + 40},
        {"Linear Matriks", HARI[2] + JAM[8] + 0, HARI[2] + JAM[9] + 40},
        {"Alpro", HARI[1] + JAM[8] + 0, HARI[1] + JAM[9] + 40},
        ...
        {"kalkulus 1 c", HARI[2] + JAM[10] + 0, HARI[2] + JAM[12] + 0}
    };
}
...
int main() {
    ...
    do {
        ...
        switch (pilihan) {case 1:addMatkul();break;case 2:dropMatkul();break;case 3:cekRingkasan();break;
            case 4:lihatDaftarMatkul();break;case 5:cout << "Terima kasih!" << endl;break;
            default:
